const contractAddress = "0x58b20Bf8f619886837808E511570f2a296fed81a"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Astro Society Multi-Token Mining NFT Project";
const welcome_h2 = "OFFICIAL NFT MINING SOON";
const welcome_p = 'Stake AstroX Nfts to earn Multi-Token Reflections';
const h1_presale_coming_soon = "NFT Drop Coming Soon!!";
const h1_presale_mint = "Pre-Sale Minting Open!!";
const h1_public_mint = "NFT Mining";
...
const p_public_mint = "Coming Soon !! 🎉";
...
const mint_failed = "Staking failed. 😢 Please try again.";
